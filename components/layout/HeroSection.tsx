        ...
        <div className="flex-1 pt-4 lg:pt-8">
            ...
            <div className="hidden lg:block">
                ...
                >
                    ...
                    >
                        <div>
                            <p className="font-outfit font-bold text-xl" style={{ color: "var(--color-text-primary)" }}>$2.4B+</p>
                            <p className="text-xs font-rubik" style={{ color: "var(--color-text-muted)" }}>Total Sent</p>
                        </div>
                        <div>
                            <p className="font-outfit font-bold text-xl" style={{ color: "var(--color-text-primary)" }}>1.2M+</p>
                            <p className="text-xs font-rubik" style={{ color: "var(--color-text-muted)" }}>Transactions</p>
                        </div>
                        <div>
                            <p className="font-outfit font-bold text-xl" style={{ color: "var(--color-text-primary)" }}>~12s</p>
                            <p className="text-xs font-rubik" style={{ color: "var(--color-text-muted)" }}>Avg. Time</p>
                        </div>
                    </motion.div>
                </motion.div>
            </div>
